...
export default function TeacherExamsPage() {
  ...
  const allExams = examsResponse?.exams?.data || []
  // Filter to only show exams created by this teacher
  const exams = allExams.filter((exam: any) => exam.teacher_id === Number(user?.id))
